...
from sortifyscan.startsortifyscan import StartSortifyScan

if __name__ == '__main__':
    StartSortifyScan.sortify_scan("D:\\StudentData\\Project\\Program\\sortifyscan\\ConveyorEmulator\\render\\0000-0105.avi")
    StartSortifyScan.sortify_scan_make_video("2024-05-04_23-29-28")
